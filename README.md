...
Web app de palpites diários da Copa do Mundo 2026. Um jogo por vez, **6 cards de palpite por partida** (Quem vence obrigatória + 5 sorteadas de um pool de 20 perguntas, iguais para todos), **ligas privadas** por código/link, **ranking** geral e por liga, e um **painel admin** para preencher os resultados.
