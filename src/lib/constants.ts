...
// Perguntas fixas por tipo de jogo.
export const FIXED_CODES_DEFAULT = ["vencedor", "placar_exato"];
export const FIXED_CODES_MATA_MATA = [
  "vencedor",
  "classificado",
  "prorrogacao",
  "disputa_penaltis",
...
export function isMataMataOrdem(ordem: number): boolean {
  return ordem >= 73;
}
